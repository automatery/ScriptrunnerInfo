...
Remove-Module ScriptrunnerInfo -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\ScriptrunnerInfo.psd1"
Import-Module "$PSScriptRoot\..\ScriptrunnerInfo.psm1" -Force
